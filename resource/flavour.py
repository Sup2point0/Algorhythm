...
flavours = WeightedList(
  ...
  (50, "Note patterns can sometimes spell out words."),
  (50, "Hold notes do not actually have to be held for their entire duration."),
  ...
  (50, "The 4 difficulties are Standing, Advancing, Expecting and... Insecurity?"),
  ...
  (50, "The highest accuracy score is 100,000."),
  
  (50, "You can create multiple accounts to save progress and settings."),
  
  (25, "Algorhythm is highly inspired by Phigros."),
  (25, "Algorhythm features original music created by yours truly (in GarageBand)."),
  ...
  (25, "Why are they called tap notes when it’s not a touchscreen game?"),
  (25, "Just how many lanes could we add?"),
  (25, "Anyone trying this one-handed?"),
  (25, "Which F# minor arpeggio is playing Algorhythm on mobile?"),
  ...
  (1, "This is a rare flavour."),
  (10, "This is a rare flavour. Or is it?"),
  (5, "This is the 26th flavour. (not really)"),
  (5, "Divulging Algorhythm’s secrets through these is fun."),
  (5, "Kinda out of ideas. Flavours, anyone?"),
  (1, "Is this load time even long enough to read all this text? Hey, what if I just write a thesis on audio analysis and automated syncing right here, then..."),
  
  (2, "[sup]"),
  (2, "I love technical redstone."),
  (2, "Hey, capitalising the S in InSane looks cool."),
  (2, "Mushroom soup is heavenly, en dash."),
  (2, "WHERE THE CLUTCH CATALYST AT"),
