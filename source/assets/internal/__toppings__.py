...
flavours = WeightedList(
  ...
  (20, "Analyze."),
  (20, "Find."),
  (20, "Actually, there is no algorithm. Only rhythm."),
  ...
  (20, "Remember to go soft on the keyboard."),
  (20, "Algorhythm doesn’t actually need sound effects if the keyboard already makes clicky sounds. Genius."),
  (20, "If you want hit sound effects, just use a mechanical keyboard :5head:"),
  (20, "Rip to anyone not playing this on a QWERTY keyboard. But hey, that’s a cool challenge."),
  (20, "No matter how difficult we make this, it seems someone’s still going to Apex Perfect it."),
  (20, "Please don’t file a copyright complaint."),
  ...
  (20, "Does music breathe you back to life?"),
  ...
  (20, "Uh, we’re not actually loading anything. Just to be clear. Enjoy the experience."),
  (20, "These flavours probably make Algorhythm a whole lot less professional. But hey, we’re here to have fun, so whatever :v"),
  ...
  (10, "The flavours just keep on coming."),
  ...
  (4, "Mushroom soup is heavenly, factorial."),
